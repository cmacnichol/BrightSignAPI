...
```
Remove-BsnDeviceTag [-DeviceId] <Int32> [-Body] <Object> [[-Connection] <PSObject>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### -Body
A hashtable/object representing the tags to remove.
Usually requires the tag ID or Name in the body based on BrightSign API specs.
